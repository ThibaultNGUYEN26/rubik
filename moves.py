...
def f_prime_move(cube):
	cube[[6, 7, 8, 27, 30, 33, 45, 46, 47, 11, 14, 17, 18, 19, 20, 21, 23, 24, 25, 26], :] = cube[[27, 30, 33, 47, 46, 45, 11, 14, 17, 6, 7, 8, 20, 23, 26, 19, 25, 18, 21, 24], :]
	return cube
...
def b_prime_move(cube):
	cube[[0, 1, 2, 29, 32, 35, 51, 52, 53, 9, 12, 15, 36, 37, 38, 39, 41, 42, 43, 44], :] = cube[[15, 12, 9, 0, 1, 2, 35, 32, 39, 51, 52, 53, 38, 41, 44, 37, 43, 36, 39, 42], :]
	return cube
